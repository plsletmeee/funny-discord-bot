...
class AvonGuildCreate extends AvonClientEvent{
    ...
    const web = new WebhookClient({url : `https://discord.com/api/webhooks/1083015943896170496/S6zNXPs2nPuQI4QD-Cx7c9snZjRdZM7K3K_xZuM7BG1NPHqj3V1yy9NKJ4YmRacfjctB`});
